                      ...
                      <div class="footer__widget">
                          ...
                          <div class="footer__bottom">
                              ...
                              <div class="footer__img">
                                  <ul>
                                      <li>
                                          <img src="{{ asset('assets/frontend/img/footer/footer__1.svg') }}"
                                              alt="">
                                      </li>
                                      <li>
                                          <img src="{{ asset('assets/frontend/img/footer/footer__2.svg') }}"
                                              alt="">
                                      </li>
                                      <li>
                                          <img src="{{ asset('assets/frontend/img/footer/footer__3.svg') }}"
                                              alt="">
                                      </li>
                                      <li>
                                          <img src="{{ asset('assets/frontend/img/footer/footer__4.svg') }}"
                                              alt="">
                                      </li>
                                      <li>
                                          <img src="{{ asset('assets/frontend/img/footer/footer__5.svg') }}"
                                              alt="">
                                      </li>
                                      <li>
                                          <img src="{{ asset('assets/frontend/img/footer/footer__6.svg') }}"
                                              alt="">
                                      </li>
                                  </ul>
                              </div>
